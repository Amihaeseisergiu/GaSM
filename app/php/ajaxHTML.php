...
if (isset($data['timeFilter'])) {
    ...
    $canvasWrapper1 = $doc->createElement('div');
    $canvasWrapper1->setAttribute('class', 'canvasWrapper');
    $childDivNode1->appendChild($canvasWrapper1);
    $canvasWrapper1->appendChild($childCanvasNode1);
    ...
    $canvasWrapper2 = $doc->createElement('div');
    $canvasWrapper2->setAttribute('class', 'canvasWrapper');
    $childDivNode2->appendChild($canvasWrapper2);
    $canvasWrapper2->appendChild($childCanvasNode2);
